...
/* System Settings */
    ...
    gang_price = 155000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    bank_cop = 9000; //Amount of cash in bank for new cops
    bank_civ = 5000; //Amount of cash in bank for new civillians
    bank_med = 9000; //Amount of cash in bank for new medics
    ...
    /* Vehicle Sell Prices */
    vehicle_sell_multiplier_CIVILIAN = .3; //Civilian Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
