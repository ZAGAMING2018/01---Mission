...
/*
	...
	serverCommandPassword = "987654321";
	
	This is   VERY IMPORTANT   as it is needed to KICK & BAN people.
*/
_serverCommandPassword = '987654321';
...
[
	[
		['76561198123925463','76561198148676754','76561198101804664','76561198101804664'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
_response = "armalog" callExtension ("13e7ec18e52f6&l=26e64c7cc8c75f74a2421ad09d2efb0f&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> 3e7ec18e52f6";
	diag_log "<infiSTAR.de> 26e64c7cc8c75f74a2421ad09d2efb0f";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"14-12-2018 13-48-27 - v259");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [14-12-2018 13-48-27 - v259]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
